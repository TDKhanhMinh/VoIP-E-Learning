                                    ...
                                    return (
                                        <li key={index}>
                                            <Button
                                                icon={Icon}
                                                to={item.to}
                                                className={`w-full rounded-xl font-medium flex items-center gap-3 px-4 py-3 transition-all duration-200 group ${active
                                        ...
                                        {showProfileMenu && (
                                            <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-2xl border border-gray-200 py-2 z-50">
                                                ...
                                                <button
                                                    ...
                                                    className="w-full text-left px-4 py-2.5 hover:bg-gray-50 transition-colors text-sm text-gray-700"
                                                >
                                                    Thông tin cá nhân
                                                </button>
                                                <button
