...
const ManageChats = () => {
    ...
    useEffect(() => {
        ...
        const socketURL = import.meta.env.VITE_API_URL.replace(/\/api\/?$/, "").replace(/\/$/, "") + "/chat";
    ...
    const loadConversations = async () => {
        try {
            ...
            console.log("load Conversation res", response);
    ...
    const loadMessages = async (conversationId) => {
        try {
            ...
            console.log("loadMessage res", response);
                                    ...
                                    {conversations.map((conv) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                className={`p-4 cursor-pointer transition-all duration-200 border-b border-gray-100 hover:bg-blue-50 ${selectedChat?._id === conv._id
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        {conv.lastMessage ? (
                                                            <p className={`mt-2 text-sm truncate ${unreadCount > 0 ? "text-gray-800 font-bold" : "text-gray-600"
                                                                ...
                                                                {conv.lastMessage.sender !== userID ? "" : "Bạn: "}
