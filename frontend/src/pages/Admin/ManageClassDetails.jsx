...
export default function ClassDetail() {
    ...
    const fetchClassDetails = async () => {
        ...
        try {
            ...
            setAllStudents(await userService.getAllUsers().then(users => users.filter(u => u.role === 'student')));
    ...
    const handleDeleteUser = async (enrollment) => {
        try {
            ...
            toast.error(error?.response?.data?.message || "Lỗi khi xóa sinh viên khỏi lớp");
