  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 overflow-hidden">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl flex flex-col h-[90vh] animate-in fade-in zoom-in duration-200">
        <div className="flex-none flex items-center justify-between p-5 border-b border-gray-100">
        ...
        <div className="flex-1 overflow-hidden p-6 flex flex-col w-full">
          <div className="quill-wrapper-fix h-full flex flex-col">
            <ReactQuill
              theme="snow"
              value={value}
              onChange={setValue}
        ...
        <div className="flex-none px-5 py-2.5 border-t border-gray-100 bg-gray-50 rounded-b-xl flex justify-end gap-3">
          <button
            onClick={onClose}
