...
export default function AddStudentsModal({
  ...
  useEffect(() => {
    const fetchData = async () => {
      const studentsEnrolled = await enrollmentService
        .getAllEnrollments(classId)
              ...
              <div className="px-6 py-4 bg-gradient-to-b from-gray-50 to-white dark:from-gray-700 dark:to-gray-800 border-b dark:border-gray-700">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-white dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-400 outline-none transition-all duration-200 placeholder:text-gray-400 dark:placeholder:text-gray-500 dark:text-white"
                  />
                </div>
              </div>
                        ...
                        <div className="col-span-1 flex items-center">
                          <div className="relative">
                            <input
                              ...
                              className="w-5 h-5 text-blue-600 rounded border-2 border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 cursor-pointer transition-all"
                            />
                            {selected.includes(s._id) && (
                              <FaCheckCircle className="absolute -top-1 -right-1 text-blue-600 text-xs bg-white dark:bg-gray-800 rounded-full" />
                            )}
                          </div>
                        </div>
                        <span className="col-span-4 font-semibold text-gray-800 dark:text-white flex items-center">
                          {s.full_name}
                        </span>
                        <span className="col-span-3 text-gray-600 dark:text-gray-300 font-mono text-sm flex items-center">
                          {s.student_id}
                        </span>
                        <span className="col-span-4 text-gray-500 dark:text-gray-400 text-sm flex items-center truncate">
                          {s.email}
                        </span>
                      </div>
                    ))}
              ...
              <div className="px-6 py-4 bg-gradient-to-r from-gray-50 to-blue-50 border-t flex items-center justify-between">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="px-5 py-2.5 bg-white dark:bg-gray-700 border-2 border-gray-300 dark:border-gray-600 hover:border-gray-400 dark:hover:border-gray-500 text-gray-700 dark:text-gray-200 font-medium rounded-xl transition-all duration-200 hover:shadow-md"
                  >
                    Hủy bỏ
                  </button>
                  <button
                    ...
                    className={`px-6 py-2.5 font-medium rounded-xl transition-all duration-200 flex items-center gap-2 ${
                      selected.length === 0
