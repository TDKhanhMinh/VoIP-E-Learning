...
import { FaTimes, FaUser, FaEnvelope, FaLock, FaUserTag } from "react-icons/fa";
...
export default function AddUserModal({
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-black/60 to-black/40 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl w-full max-w-lg relative transform transition-all animate-fadeIn overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-32 bg-gradient-to-br from-blue-500 via-blue-600 to-indigo-600 opacity-10 dark:opacity-20"></div>

        <button
          onClick={onClose}
          className="absolute top-5 right-5 text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full p-2 transition-all z-10"
        >
          <FaTimes size={20} />
        </button>
        ...
        <div className="relative p-8">
          ...
          <form onSubmit={handleSubmit(submitHandler)} className="space-y-5">
            <div className="group">
              ...
              {errors.full_name && (
                <p className="text-red-500 dark:text-red-400 text-xs mt-1.5 ml-1 flex items-center gap-1">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                type="submit"
                className={`flex-1 px-6 py-3 rounded-xl font-semibold shadow-lg transition-all hover:shadow-xl transform hover:-translate-y-0.5 ${
                  isUpdate
