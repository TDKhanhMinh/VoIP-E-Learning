...
export default function SemesterModal({
  ...
  return (
    ...
    >
      ...
      <div className="bg-gray-100 dark:bg-gray-800 rounded-3xl shadow-2xl w-[460px] z-10 relative overflow-hidden border border-gray-200 dark:border-gray-700">
        <div className="absolute top-0 left-0 right-0 h-28 bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 dark:from-blue-900 dark:via-indigo-900 dark:to-purple-900 opacity-80 dark:opacity-90"></div>
        ...
        <div className="relative p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              ...
              <input
                type="date"
                className="w-full border-2 border-gray-200 dark:border-gray-600 rounded-xl px-4 py-3 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:focus:border-blue-400 outline-none transition-all"
                {...register("start_date", {
