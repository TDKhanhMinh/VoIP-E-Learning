export default function ExamSkeleton() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 p-4 gap-4 animate-pulse">
      <div className="flex-1 p-6 col-span-1 lg:col-span-3 bg-white rounded-lg shadow-lg border border-gray-200">
      ...
      <div className="bg-white border-r p-4 w-full rounded-lg shadow-lg border border-gray-200 h-fit">
